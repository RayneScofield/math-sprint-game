...
function updateBestScore() {
  bestScoreArray.forEach((score, index) => {
    ...
    // console.log('type of questionAmount:', typeof (questionAmount));
...
function checkTime() {
  // console.log('timePlayed', timePlayed, 'typeof questionAmount', typeof (questionAmount));
...
function select(guessedTrue) {
  // console.log('playerGuessArray', playerGuessArray, 'equationsArray', equationsArray);
